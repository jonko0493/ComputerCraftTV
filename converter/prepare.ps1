...
ffmpeg -i "$videoFile" -vf "fps=20,crop=1440:1080:240:0,scale=512:384,subtitles='$videoFile':si=0" $channelDir/$channel/img512/%05d.png
ffmpeg -i "$videoFile" -vf "fps=20,crop=1440:1080:240:0,scale=256:192,subtitles='$videoFile':si=0" $channelDir/$channel/img256/%05d.png
